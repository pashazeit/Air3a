...
import com.company.InterFace.outFuel;
...
public class Aircraft extends AviaComp implements outFuel {
    ...
    String[] Air = {"Boing", "Colt", "AirBus", "Carpet-plane", "Humpbacked Horse", "Stupa Baba Yaga", "Geese-swans", "Hogwarts Express", "The core of Baron Munchausen"};
